	...
	extends AbstractMojo
{
	 ...
	 * 
	 * @parameter alias="gemFinalName" expression="${gem.finalName}"
	 ...
	 * 
	 * @parameter alias="gemBaseName" expression="${gem.baseName}"
	 ...
	 * 
	 * @parameter expression="${gem.libsourceDirectory}"
	 *            default-value="${project.basedir}/src/main/ruby"
	 * @required
	 */
	 ...
	 * 
	 * @parameter expression="${gem.binSourceDirectory}"
	 ...
	 * 
	 * @parameter expression="${gem.testSourceDirectory}"
	 *            default-value="${project.basedir}/src/test/ruby"
	 */
	...
	protected String[] scanDirectory (String base, String includes[], String excludes[]) throws MojoExecutionException {
