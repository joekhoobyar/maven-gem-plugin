	...
	extends AbstractRubyGemMojo
{
        ...
        throws MojoExecutionException
  {
    ...
    sb.append ("required_rubygems_version: ").append (requiredRubygemsVersion==null ? "" : requiredRubygemsVersion).append ("\n");
    sb.append ("required_ruby_version: ").append (requiredRubyVersion==null ? "" : requiredRubyVersion).append ("\n");
    ...
    catch (IOException e) { throw new MojoExecutionException ("IO error while writing gemspec ("+gemspec.getAbsolutePath ()+")", e); }
    finally { try { if (wr!=null) wr.close (); } catch (IOException ignore) { } }
  }
  ...
  @SuppressWarnings("unchecked")
  private String[] getExtensions () { return null; }
}
